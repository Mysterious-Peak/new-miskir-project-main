...
const gatePenalty = {
  name: 'Gate Penalty',
  param: 'gate_penalty',
  description: 'A penalty applied when a gate with no access information is on the road. The default gate penalty is 300 seconds.',
  unit: 'sec',
  settings: {
    min: 0,
    max: 600,
...
const transitStartEndMaxDistance = {
  ...
  description: 'Maximum walking distance at the beginning or end of a transit route',
  unit: 'meters',
  settings: {
    min: 0,
    max: 10000,
...
const privateAccessPenalty = {
  ...
  description: 'A penalty applied when a gate or bollard with access=private is encountered. The default private access penalty is 450 seconds.',
  unit: 'sec',
  settings: {
    min: 0,
    max: 5000,
...
const ignoreClosures = {
  ...
  description: 'If set to true, ignores all closures, marked due to live traffic closures, during routing. ',
...
const serviceFactor = {
  ...
  description: 'A factor that modifies (multiplies) the cost when generic service roads are encountered. The default service_factor is 1.',
  unit: 'factor',
  settings: {
    min: 1,
    max: 50,
...
const ignoreHierarchies = {
  ...
  description: 'Forces routing algorithms to not use hierarchies (or shortcuts)',
...
const walkingSpeed = {
  name: 'Walking Speed',
  param: 'walking_speed',
  description: 'Walking speed in kilometers per hour. Must be between 0.5 and 25 km/hr. Defaults to 5.1 km/hr (3.1 miles/hour).',
  unit: 'kmh',
  settings: {
    min: 0.5,
    max: 25,
...
export const profile_settings = {
  ...
  car: {
    ...
    boolean: [shortest, includeHOV2, includeHOV3, includeHot, ignoreHierarchies],
    enum: []
  },
  bus: {
    numeric: [
  ...
  pedestrian: {
    numeric: [useHills, useLit, walkingSpeed, walkwayFactor, sidewalkFactor, alleyFactor, drivewayFactor, stepPenalty, maxHikingDifficulty],
    boolean: [shortest],
    enum: []
  },
  motor_scooter: {
    numeric: [useHills, topSpeed, usePrimary, useLivingStreets, maneuverPenalty, gateCost, gatePenalty, countryCrossingCost, countryCrossingPenalty],
    boolean: [shortest, ignoreHierarchies],
    enum: []
  },
  bicycle: {
    numeric: [cyclingSpeed, useRoads, useHills, avoidBadSurfaces, maneuverPenalty, gateCost, gatePenalty],
    boolean: [shortest],
    enum: [bicycleType]
  },
  motorcycle: {
...
export const settings_general = {
  truck: {
    numeric: [turnPenaltyCost, useHighways, useTollways, tollBoothCost, tollBoothPenalty, useFerry, ferryCost, useLivingStreets, useTracks],
    boolean: [ignoreClosures, ignoreRestrictions, ignoreAccess, excludeUnpaved, excludeCashOnlyTolls, includeHOV3, includeHOV2, includeHot],
    enum: []
  },
  car: {
    numeric: [turnPenaltyCost, useHighways, useTollways, tollBoothCost, tollBoothPenalty, useFerry, ferryCost, useLivingStreets, useTracks],
    boolean: [ignoreClosures, ignoreRestrictions, ignoreAccess, excludeUnpaved, excludeCashOnlyTolls],
    enum: []
  },
  bus: {
    numeric: [turnPenaltyCost, useHighways, useLivingStreets, useTollways, tollBoothCost, tollBoothPenalty, useFerry, ferryCost, useTracks],
    boolean: [ignoreClosures, ignoreRestrictions, ignoreAccess, excludeUnpaved, excludeCashOnlyTolls],
    enum: []
  },
  pedestrian: {
    numeric: [useFerry, servicePenalty, serviceFactor, useLivingStreets, useTracks, transitStartEndMaxDistance, transitTransferMaxDistance],
    boolean: [],
    enum: []
  },
  motor_scooter: {
  ...
  bicycle: {
    numeric: [useFerry, useLivingStreets, turnPenaltyCost, servicePenalty, serviceFactor],
    boolean: [],
    enum: []
  },
  motorcycle: {
    ...
    boolean: [ignoreClosures, ignoreRestrictions, ignoreAccess, excludeCashOnlyTolls],
    enum: []
  },
  all: {
