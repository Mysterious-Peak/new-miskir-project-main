export default {
  ...
  farmland: {
    farmerId: 'Farmer ID',
    kebeleId: 'Kebele ID',
    alertHolderFarmerId: 'Please input Farmer ID',
    alertHolderKebeleId: 'Please input Kebele ID',
    // Requirement 2.3: Farmland form new attributes
    soilCode: 'Soil Type',
    irrigationCode: 'Irrigation Type',
    landOwnershipType: 'Land Ownership Type',
    slopeAspect: 'Aspect / Slope Direction',
    samplingDepth: 'Sampling depth',
    landUseRecord: 'Land use history',
    infrastructureAccessibility: 'Accessibility of land to infrastructure',
    infrastructureAccessibilityPlaceholder: 'Describe distance/time to nearest road and available utilities'
  }
};
