<template>
  <div class="big-screen">
    ...
    <div class="screen-header">
      ...
      <h1>Oromia Regional Environmental Protection Bureau</h1>
      <p>Focus: Environmental sustainability and climate resilience</p>
    </div>
    ...
    <div class="screen-body">
      <div class="screen-top">
        <div class="side-panel">
          <div class="panel-card">
            <div class="card-title">Climate Resilience Trend Indicators</div>
            <div ref="inputTypeChartRef" class="chart-box"></div>
          </div>
          <div class="panel-card">
            <div class="card-title">Climate Resilience Capability Radar</div>
        ...
        <div class="center-panel">
          <div class="panel-card map-card">
            <div class="card-title">Forest Coverage Map</div>
        ...
        <div class="side-panel">
          <div class="panel-card">
            <div class="card-title">Environmental Monitoring Board</div>
            <div ref="coverageTrendChartRef" class="chart-box"></div>
          </div>
          <div class="panel-card">
            <div class="card-title">Agricultural Waste Recycling Performance</div>
      ...
      <div class="screen-bottom">
        <div class="panel-card bottom-left-card">
          <div class="card-title">Climate-Environment Correlation Analysis</div>
          <div ref="bottomTrendChartRef" class="chart-box bottom-chart-box"></div>
        </div>
        <div class="panel-card bottom-right-card">
          <div class="card-title">Environmental Feed & Alerts</div>
...
const kpiCardPayload = {
  module: 'kpi_environment',
  data: [
    {
      id: 'kpi_1',
      label: 'Climate-smart agriculture adoption rate',
      value: 68.4,
      unit: '%',
      trend: 3.2,
      trend_direction: 'up',
      status_color: '#10B981',
      sparkline_data: [58.5, 61.2, 64.8, 68.4],
      icon: 'eco'
    },
    {
      id: 'kpi_2',
      label: 'Pollution reduction rate',
      value: 18.7,
      unit: '%',
      trend: 2.4,
      trend_direction: 'up',
      status_color: '#10B981',
      sparkline_data: [11.8, 13.2, 16.3, 18.7],
      icon: 'air'
    },
    {
      id: 'kpi_3',
      label: 'Agricultural waste recycling rate',
      value: 74.6,
      unit: '%',
      trend: 4.8,
      trend_direction: 'up',
      status_color: '#10B981',
      sparkline_data: [61.5, 66.2, 70.1, 74.6],
      icon: 'recycling'
    },
    {
      id: 'kpi_4',
      ...
      trend_direction: 'up',
      status_color: '#10B981',
      sparkline_data: [1150.2, 1195.4, 1248.9, 1284.5],
      icon: 'forest'
    },
    {
      id: 'kpi_5',
      label: 'Biodiversity actions implemented',
      value: 39,
      unit: 'actions',
      trend: 6,
      trend_direction: 'up',
      status_color: '#3B82F6',
      sparkline_data: [24, 28, 33, 39],
      icon: 'pets'
    }
  ]
};
  ...
  zones: [
    {
      ...
      center: [39.27, 8.54],
      metrics: { forest_cover_pct: 41.5, protected_area_kha: 286.2, biodiversity_actions: 9, emission_reduction_pct: 22.1 }
    },
    {
      zone_id: 'JIMMA',
      zone_name: 'Jimma',
      center: [36.83, 7.67],
      metrics: { forest_cover_pct: 38.8, protected_area_kha: 241.6, biodiversity_actions: 7, emission_reduction_pct: 19.4 }
    },
    {
      zone_id: 'WEST_WELEGA',
      zone_name: 'West Welega',
      center: [36.55, 9.08],
      metrics: { forest_cover_pct: 33.2, protected_area_kha: 198.4, biodiversity_actions: 6, emission_reduction_pct: 16.1 }
    },
    {
      zone_id: 'EAST_HARARGE',
      zone_name: 'East Hararghe',
      center: [40.87, 9.08],
      metrics: { forest_cover_pct: 27.5, protected_area_kha: 162.8, biodiversity_actions: 5, emission_reduction_pct: 13.5 }
    },
    {
      zone_id: 'BORENA',
      zone_name: 'Borena',
      center: [39.58, 5.33],
      metrics: { forest_cover_pct: 21.3, protected_area_kha: 123.7, biodiversity_actions: 4, emission_reduction_pct: 10.2 }
    },
    {
      zone_id: 'BALE',
      zone_name: 'Bale',
      center: [39.95, 6.85],
      metrics: { forest_cover_pct: 29.6, protected_area_kha: 176.4, biodiversity_actions: 6, emission_reduction_pct: 12.7 }
    },
    {
      zone_id: 'ARSI',
      zone_name: 'Arsi',
      center: [38.75, 7.1],
      metrics: { forest_cover_pct: 34.1, protected_area_kha: 208.9, biodiversity_actions: 7, emission_reduction_pct: 15.8 }
    },
    {
      zone_id: 'GUJI',
      zone_name: 'Guji',
      center: [38.52, 5.95],
      metrics: { forest_cover_pct: 24.8, protected_area_kha: 141.5, biodiversity_actions: 5, emission_reduction_pct: 11.9 }
    },
    {
      zone_id: 'WEST_ARSI',
      zone_name: 'West Arsi',
      center: [38.2, 6.95],
      metrics: { forest_cover_pct: 31.9, protected_area_kha: 196.7, biodiversity_actions: 7, emission_reduction_pct: 14.1 }
    },
    {
      zone_id: 'NORTH_SHEWA',
      zone_name: 'North Shewa(R4)',
      center: [39.1, 9.45],
      metrics: { forest_cover_pct: 30.4, protected_area_kha: 185.2, biodiversity_actions: 6, emission_reduction_pct: 17.2 }
    },
    {
      zone_id: 'WEST_SHEWA',
      zone_name: 'West Shewa',
      center: [38.15, 9.12],
      metrics: { forest_cover_pct: 32.8, protected_area_kha: 202.1, biodiversity_actions: 8, emission_reduction_pct: 16.8 }
    }
  ]
};
  ...
  alerts: [
    {
      ...
      zone_name: 'Borena',
      message_html:
        "<b>Borena</b>: PM and dust levels remain high; pollution reduction progress is only <span style='color:#EF4444;font-weight:bold'>62%</span>. Immediate joint remediation is recommended.",
    ...
    },
    {
      ...
      zone_name: 'East Shewa',
      message_html:
        "<b>East Shewa</b>: This quarter added <span style='color:#10B981;font-weight:bold'>18.4</span> k ha of forest restoration, with strong progress in biodiversity actions.",
    ...
    },
    {
      ...
      zone_name: 'Jimma',
      message_html:
        '<b>Jimma</b>: Agricultural waste recycling rate fell <span style="color:#F97316;font-weight:bold">4.1%</span> MoM. Check collection, storage, and transfer workflow.',
    ...
    },
    {
      ...
      message_html:
        "<b>Regional brief</b>: Climate-smart agriculture adoption has reached <span style='color:#F8FAFC;font-weight:bold'>68.4%</span>; annual environmental targets are broadly on track.",
...
const productionComboPayload = {
  module: '2.2.1_climate_resilience_trend',
  title: 'Monthly Climate Resilience Trend',
  x_axis: ['2025-04', '2025-05', '2025-06', '2025-07', '2025-08', '2025-09', '2025-10', '2025-11', '2025-12', '2026-01', '2026-02', '2026-03'],
  series: [
    {
      name: 'Climate-smart adoption (%)',
      type: 'bar',
      color_gradient: ['#10B981', '#059669'],
      y_axis_index: 0,
      data: [52.1, 53.4, 55.2, 56.8, 58.9, 60.2, 61.7, 63.1, 64.8, 66.0, 67.1, 68.4]
    },
    {
      ...
      symbol: 'circle',
      y_axis_index: 1,
      data: [9.2, 9.8, 10.6, 11.5, 12.8, 13.9, 14.7, 15.4, 16.2, 17.1, 17.9, 18.7]
    }
  ]
};
...
const efficiencyRadarPayload = {
  module: '2.2.2_climate_resilience_radar',
  title: 'Climate Resilience Capability Radar',
  indicators: [
    { name: 'Climate-smart agriculture', max: 100 },
    { name: 'Pollution mitigation', max: 100 },
    { name: 'Waste valorization', max: 100 },
    { name: 'Forest protection', max: 100 },
    { name: 'Biodiversity protection', max: 100 },
    { name: 'Climate emergency readiness', max: 100 }
  ],
  target_line: [82, 75, 78, 80, 76, 74],
  actual_data: [68, 63, 74, 71, 66, 69],
...
const buildQualityRadarOption = () => ({
  ...
  legend: {
    ...
    data: ['Annual target', 'Current level']
  },
  radar: {
    radius: '56%',
    center: ['50%', '42%'],
  ...
  series: [
    ...
    },
    {
      ...
      data: [{ value: efficiencyRadarPayload.actual_data, name: 'Current level' }]
    }
  ]
});
  ...
  return {
    ...
    tooltip: {
      ...
      formatter: (p: any) => {
        ...
        if (!metrics) return p?.name || 'Oromia';
        return [
          `<b>${p.name}</b>`,
          `Forest coverage: ${Number(metrics.forest_cover_pct).toFixed(1)}%`,
          `Protected area: ${Number(metrics.protected_area_kha).toFixed(1)} k ha`,
          `Biodiversity actions: ${Number(metrics.biodiversity_actions).toFixed(0)}`,
          `Pollution reduction: ${Number(metrics.emission_reduction_pct).toFixed(1)}%`
        ].join('<br/>');
      }
    },
    graphic: [
...
const supplyDemandPayload = {
  module: '2.4.1_environment_monitoring_board',
  strategy: 'TOP_BOTTOM_5',
  unit: '%',
  balance_zero_line: 0,
  data: [
    { zone: 'East Shewa', value: 6.5, type: 'surplus', rank: 1 },
    { zone: 'West Arsi', value: 4.2, type: 'surplus', rank: 2 },
    { zone: 'Jimma', value: 2.8, type: 'surplus', rank: 3 },
    { zone: 'Arsi', value: 1.1, type: 'surplus', rank: 4 },
    { zone: 'West Welega', value: -0.6, type: 'deficit', rank: -4 },
    { zone: 'Guji', value: -1.9, type: 'deficit', rank: -3 },
    { zone: 'Bale', value: -3.4, type: 'deficit', rank: -2 },
    { zone: 'Borena', value: -7.1, type: 'deficit', rank: -1 }
  ]
};

const buildCoverageTrendOption = () => {
  const zones = supplyDemandPayload.data.map((item) => item.zone);
  ...
  return {
    tooltip: {
      ...
      formatter: (params: any[]) => {
        ...
        const type = row?.type === 'balanced' ? 'On target' : val >= 0 ? 'Above target' : 'Below target';
        return `${zone}<br/>${type}: ${Math.abs(val).toFixed(1)}${supplyDemandPayload.unit}`;
      }
    },
    grid: { left: 88, right: 48, top: 24, bottom: 24 },
    xAxis: {
      type: 'value',
      min: -axisExtent,
      max: axisExtent,
    ...
    series: [
      {
        name: 'Reduction target variance',
        type: 'bar',
        data: barValues,
        barWidth: 8,
        itemStyle: {
        ...
        label: {
          ...
          color: '#f8fafc',
          fontSize: 10,
          formatter: (params: any) => `${Math.abs(Number(params.value)).toFixed(1)}%`,
          position: (params: any) => (Number(params.value) >= 0 ? 'right' : 'left'),
          distance: 6
        },
        markLine: {
          silent: true,
...
const agriWasteMonitoringPayload = {
  module: '2.4.2_agri_waste_recycling',
  title: 'Agricultural Waste Recycling Target Tracking',
  target_pct: 80,
  data: [
    { zone: 'East Shewa', recycle_pct: 84.5, annual_tons: 28200 },
    { zone: 'West Arsi', recycle_pct: 80.8, annual_tons: 22400 },
    { zone: 'Jimma', recycle_pct: 78.6, annual_tons: 24600 },
    { zone: 'Arsi', recycle_pct: 76.9, annual_tons: 19800 },
    { zone: 'Bale', recycle_pct: 72.4, annual_tons: 17100 },
    { zone: 'Guji', recycle_pct: 69.8, annual_tons: 14900 },
    { zone: 'Borena', recycle_pct: 63.1, annual_tons: 13200 }
  ]
};

const buildDeliveryGaugeOption = () => {
  const rows = [...agriWasteMonitoringPayload.data].sort((a, b) => a.recycle_pct - b.recycle_pct);
  const target = agriWasteMonitoringPayload.target_pct;
  ...
  return {
    tooltip: {
      ...
      formatter: (params: any[]) => {
        ...
        const row = rows[idx];
        if (!row) return '';
        const gap = row.recycle_pct - target;
        return `${row.zone}<br/>Recycling rate: <b>${row.recycle_pct.toFixed(1)}%</b><br/>Annual throughput: ${row.annual_tons.toLocaleString()} tons<br/>Gap vs target: ${gap >= 0 ? '+' : ''}${gap.toFixed(1)}%`;
      }
    },
    grid: { left: 98, right: 36, top: 20, bottom: 24 },
    xAxis: {
      type: 'value',
      min: 0,
      max: 100,
    ...
    series: [
      {
        ...
        type: 'bar',
        barWidth: 10,
        data: rows.map((item) => item.recycle_pct),
        itemStyle: {
          borderRadius: [0, 8, 8, 0],
          color: (params: any) => {
            const v = Number(params?.value ?? 0);
            if (v >= target) return '#10B981';
            if (v >= target - 8) return '#3B82F6';
            return '#F97316';
          }
        },
        label: {
        ...
        markLine: {
          ...
          label: { show: true, formatter: `Target ${target}%`, color: '#FBBF24', fontSize: 10 }
        }
      }
    ]
  };
...
const scatterAnalysisPayload = {
  module: '2.5.1_climate_environment_correlation',
  x_axis: { label: 'Climate-smart adoption (%)', min: 0, max: 100 },
  y_axis: { label: 'Pollution reduction (%)', min: 0, max: 30 },
  quadrants: [
    { id: 'Q1', label: 'High adoption, high reduction' },
    { id: 'Q2', label: 'Low adoption, high reduction' },
    { id: 'Q3', label: 'Low adoption, low reduction' },
    { id: 'Q4', label: 'High adoption, low reduction' }
  ],
  points: [
    {
      zone_id: 'EAST_SHEWA',
      ...
      y: 22.1,
      category: 'MODEL_ZONE',
      tooltip: 'East Shewa: adoption 78.5%, reduction 22.1%'
    },
    {
      zone_id: 'JIMMA',
      zone_name: 'Jimma',
      ...
      y: 19.4,
      category: 'MODEL_ZONE',
      tooltip: 'Jimma: adoption 72.0%, reduction 19.4%'
    },
    {
      zone_id: 'WEST_ARSI',
      zone_name: 'West Arsi',
      ...
      tooltip: 'West Arsi: adoption 35.0%, reduction 14.1%'
    },
    {
      zone_id: 'EAST_HARARGE',
      zone_name: 'East Hararghe',
      ...
      tooltip: 'East Hararghe: adoption 38.0%, reduction 13.5%'
    },
    {
      zone_id: 'BORENA',
      zone_name: 'Borena',
      ...
      y: 10.2,
      category: 'KEY_SUPPORT',
      tooltip: 'Borena: adoption 24.5%, reduction 10.2%'
    },
    {
      zone_id: 'SPECIAL_ZONE_X',
      zone_name: 'Environmental Demonstration Zone',
      cluster_color: '#8B5CF6',
      x: 85,
      y: 21,
      category: 'EFFICIENCY_ISSUE',
      tooltip: 'Demonstration Zone: adoption 85.0%, reduction 21.0% (structural anomaly)'
    },
    {
      zone_id: 'WEST_SHEWA',
      zone_name: 'West Shewa',
      ...
      y: 16.8,
      category: 'MODEL_ZONE',
      tooltip: 'West Shewa: adoption 58.0%, reduction 16.8%'
    },
    {
      zone_id: 'NORTH_SHEWA',
      ...
      y: 17.2,
      category: 'MODEL_ZONE',
      tooltip: 'North Shewa: adoption 61.5%, reduction 17.2%'
    },
    {
      ...
      y: 24.7,
      category: 'EFFICIENCY_ISSUE',
      tooltip: 'Special Zone AA: adoption 82.7%, reduction 24.7% (high input, low efficiency)'
    },
    {
      zone_id: 'BALE',
      zone_name: 'Bale',
      ...
      y: 12.7,
      category: 'KEY_SUPPORT',
      tooltip: 'Bale: adoption 32.0%, reduction 12.7%'
    },
    {
      zone_id: 'ARSI',
      zone_name: 'Arsi',
      ...
      y: 15.8,
      category: 'POTENTIAL_NAT',
      tooltip: 'Arsi: adoption 49.5%, reduction 15.8%'
    }
  ]
};
  ...
  return {
    tooltip: {
      ...
      formatter: (params: any) => {
        ...
        return `${data?.zone_name || ''}<br/>Climate-smart adoption: ${params.value?.[0]}%<br/>Pollution reduction: ${params.value?.[1]}%`;
      }
    },
