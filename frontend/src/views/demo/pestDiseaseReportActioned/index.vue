...
<script setup name="PestDiseaseReport Actioned" lang="ts">
import {
...
const data = reactive<PageData<PestDiseaseReportForm, PestDiseaseReportQuery>>({
  ...
  queryParams: {
    ...
    aiDiagnosis: undefined,
    recommendedAction: undefined,
    status: PestDiseaseStatus.Approved.toString(),
    recordedBy: undefined,
    verifiedBy: undefined,
    deptId: undefined,
    params: {},
...
const handleUpdate = (row?: PestDiseaseReportVO) => {
  ...
  router.push({ name: 'ActionPestDiseaseReport', params: { id: _pestId } });
};
