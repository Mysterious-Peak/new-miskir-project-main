  ...
  <div v-loading="pageLoading" class="p-2">
    <el-card shadow="never">
      ...
      <el-form ref="pestDiseaseReportFormRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-form-item label="Approved By" prop="verifiedUserName">
      ...
      <div class="form-footer">
        <el-button :loading="buttonLoading" type="primary" @click="submitForm">Action</el-button>
        <el-button :loading="buttonLoading" type="warning" @click="closeReportForm">Close</el-button>
...
<script setup name="PestDiseaseReportActionedForm" lang="ts">
...
const submitForm = () => {
  ...
  pestDiseaseReportFormRef.value?.validate(async (valid: boolean) => {
    if (valid) {
      ...
      form.value.status = PestDiseaseStatus.Actioned.toString();
...
const closeReportForm = () => {
  ...
  pestDiseaseReportFormRef.value?.validate(async (valid: boolean) => {
    if (valid) {
      ...
      form.value.status = PestDiseaseStatus.Closed.toString();
